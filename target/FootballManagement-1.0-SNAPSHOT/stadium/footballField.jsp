                ...
                <div class="col-sm-3 box-search">
                    <div class="football-search">
                        <div class="football-content">
                            ...
                            <ul class="cat-item">
                                <li><a href="#">First</a><span>156</span></li>
                                <li><a href="#">Second</a><span>78</span></li>
                                <li><a href="#">Third</a><span>32</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row list-stadium">
            <c:forEach var="stadium" items="${stadiums}">
                <div class="stadium col-sm-4 mb-4">
                    <div class="listing-item" style="height: 432px;">
                        ...
                        <div class="title-stadium">
                            ...
                            <div class="row detail">
                                <div class="col-12 p-12">
                                    <a href="${pageContext.request.contextPath}/stadium/detail?id=${stadium.stadiumID}">
