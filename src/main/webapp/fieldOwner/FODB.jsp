            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        %>
                        <tr>
                            <td><strong>#<%= booking.getBookingID() %>
                            </strong></td>
                            <td>
                                <div>
                                    <strong><%= booking.getCustomerName() != null ? booking.getCustomerName() : "N/A" %>
                                    </strong><br>
                                    <small class="text-muted"><%= booking.getCustomerEmail() %>
                                    </small>
                                    <% if (booking.getCustomerPhone() != null) { %>
                                    <br><small class="text-muted"><i
                                        class="fas fa-phone"></i> <%= booking.getCustomerPhone() %>
                                </small>
                                    <% } %>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <strong><%= booking.getStadiumName() %>
                                    </strong><br>
                                    <small class="text-muted"><%= booking.getFieldName() %>
                                        (<%= booking.getFieldType() %>)</small>
                                </div>
                            </td>
                            <td><%= dateFormat.format(booking.getBookingDate()) %>
                            </td>
                            <td><%= timeFormat.format(booking.getStartTime()) %>
                                - <%= timeFormat.format(booking.getEndTime()) %>
                            </td>
                            <td><strong class="text-success"><%= currencyFormat.format(booking.getTotalAmount()) %>
                            </strong></td>
                            <td>
                                <%
                            ...
                            <td><small class="text-muted"><%= datetimeFormat.format(booking.getCreatedAt()) %>
                            </small></td>
                        </tr>
                        <%
                                count++;
